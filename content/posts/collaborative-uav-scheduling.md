...
D_i(t)
=
\sum_{l=1}^{s_i(t)-1}\frac{C_i^{(l)}}{f_i(t)}
+
I_i^{off}(t)
\left(
\frac{S_i^{(s_i(t)-1)}}{R_{i,o_i(t)}(t)}
+T_{penalty}
+
\sum_{l=s_i(t)}^{L}
\frac{C_i^{(l)}}{f_{o_i(t)}(t)}
\right).
$$
...
D_t
=
\max_{i\in\mathcal C_t}
\left(
D_i(t)+I_i^{res}(t)\frac{S_{res}}{R_{o_i(t),a_t}(t)}
\right)
+D_{a_t}^{dec}(t).
$$
...
E_i(t)
=
\kappa_c\sum_{l=1}^{s_i(t)-1}C_i^{(l)}[f_i(t)]^2
+
\mathbf 1_{\{o_i(t)\neq i\}}
\frac{P_i^{tx}S_i^{(s_i(t)-1)}}{R_{i,o_i(t)}(t)}
+
P_i^{fly}D_i(t).
$$
...
E_{o_i(t)}^{off}(t)
=
\frac{P_{o_i(t)}^{rx}S_i^{(s_i(t)-1)}}{R_{i,o_i(t)}(t)}
+
\kappa_c\sum_{l=s_i(t)}^L C_i^{(l)}[f_{o_i(t)}(t)]^2.
$$
...
=
\mathbf 1_{\{o_i(t)\neq a_t\}}
\frac{P_{o_i(t)}^{tx}S_{res}}{R_{o_i(t),a_t}(t)}.
$$
...
\mathbf 1_{\{o_i(t)\neq a_t\}}
\frac{P_{a_t}^{rx}S_{res}}{R_{o_i(t),a_t}(t)}
+
\kappa_c C_{fus}[f_{a_t}(t)]^2.
$$
...
=
\operatorname{cos}(
\operatorname{GAP}(H_{i,t}^v),
\operatorname{GAP}(H_{i,t}^h)
),
$$
...
\hat{\mathcal A}_t
=
\sum_{i\in\mathcal C_t}z_i(t)\hat a_i(t)
-
\lambda_r\sum_{i<j}z_i(t)z_j(t)R_{ij}(t).
$$
...
Q_j(t+1)
=
\max\{0,Q_j(t)-f_j^{loc}\Delta t+C_{in}^j(t)\}.
$$
...
=
\frac{
\exp(\beta_1\tilde c_{i,t}+\beta_2\eta_{i,t}+\beta_3\kappa_{i,t})
}{
\sum_{j\in\mathcal C_t}
\exp(\beta_1\tilde c_{j,t}+\beta_2\eta_{j,t}+\beta_3\kappa_{j,t})
}.
$$
...
l_t^\star
=
\sum_{i\in\mathcal C_t}\omega_{i,t}l_{i,t},
\qquad
p_t^\star=\operatorname{softmax}(l_t^\star).
$$
